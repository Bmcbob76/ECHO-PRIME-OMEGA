#!/usr/bin/env python3
"""
WINDOWS API MCP BRIDGE - RAW STDIO VERSION
...
class WindowsAPIMCPBridge:
    ...
    def __init__(self):
        ...
        logger.info("Windows API MCP Bridge initialized (RAW stdio version)")
    ...
    def get_tools(self) -> List[Dict[str, Any]]:
        ...
        return [
            ...
            # AUTOMATION TOOLS (pyautogui-based)
            {
                "name": "mouse_move",
            ...
            # WINDOW CONTROL TOOLS (Win32 - no cursor movement, simultaneous control)
            {
                "name": "window_list",
    ...
    async def run(self):
        ...
        logger.info(f"Windows API MCP Bridge starting...")
